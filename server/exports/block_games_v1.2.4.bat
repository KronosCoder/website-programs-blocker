...
title Game Blocker - Blocking Mode v1.2.4
color 0C
echo.
echo ========================================
...
echo. >> "%HOSTS%"
echo # ====== GAME BLOCKER v1.2.4 - START ====== >> "%HOSTS%"
...
echo # ====== GAME BLOCKER v1.2.4 - END ====== >> "%HOSTS%"
...
echo To unblock, run "unblock_games_v1.2.4.bat"
echo.
