...
title Game Blocker - Blocking Mode v1.1.0
color 0C
echo.
echo ========================================
...
echo. >> "%HOSTS%"
echo # ====== GAME BLOCKER v1.1.0 - START ====== >> "%HOSTS%"
...
echo # ====== GAME BLOCKER v1.1.0 - END ====== >> "%HOSTS%"
...
echo To unblock, run "unblock_games_v1.1.0.bat"
echo.
