...
title Game Blocker - Blocking Mode v1.1.9
color 0C
echo.
echo ========================================
...
echo. >> "%HOSTS%"
echo # ====== GAME BLOCKER v1.1.9 - START ====== >> "%HOSTS%"
...
echo # ====== GAME BLOCKER v1.1.9 - END ====== >> "%HOSTS%"
...
echo To unblock, run "unblock_games_v1.1.9.bat"
echo.
