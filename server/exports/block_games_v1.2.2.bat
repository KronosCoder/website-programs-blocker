...
title Game Blocker - Blocking Mode v1.2.2
color 0C
echo.
echo ========================================
...
echo. >> "%HOSTS%"
echo # ====== GAME BLOCKER v1.2.2 - START ====== >> "%HOSTS%"
...
echo 127.0.0.1 gemini.google.com/app >> "%HOSTS%"
echo 127.0.0.1 www.gemini.google.com/app >> "%HOSTS%"
echo 127.0.0.1 gemini.google.com >> "%HOSTS%"
echo 127.0.0.1 www.gemini.google.com >> "%HOSTS%"

echo # ====== GAME BLOCKER v1.2.2 - END ====== >> "%HOSTS%"
...
echo To unblock, run "unblock_games_v1.2.2.bat"
echo.
